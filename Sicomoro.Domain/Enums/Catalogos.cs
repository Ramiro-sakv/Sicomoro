...
public enum EstadoVenta { Pendiente = 1, Pagada = 2, ParcialmentePagada = 3, Anulada = 4, ConfirmadaPendiente = 5 }
public enum EstadoCobro { Pendiente = 1, Parcial = 2, Pagado = 3, Vencido = 4, Cancelado = 5 }
